...
public class Network {
	...
	public boolean hasWorkstation(String ws) {
		...
		if (n == null) {
			...
			return n.getType() == NodeType.WORKSTATION;
		}
	};
	...
	public boolean consistentNetwork() {
		...
		while (iter.hasMoreElements()) {
			...
			if (currentNode.getType() != NodeType.WORKSTATION) {
				return false;
			}
		}
		...
		while (!encountered.containsKey(currentNode.name_)) {
			...
			if (currentNode.getType() == NodeType.PRINTER) {
				printersFound++;
			}
	...
	public void printAccounting(Writer report, String author, String title) throws IOException {
